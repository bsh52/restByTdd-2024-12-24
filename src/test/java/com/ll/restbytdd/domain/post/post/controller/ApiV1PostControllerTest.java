...
public class ApiV1PostControllerTest {
    ...
    void t21() throws Exception {
        ...
        Page<Post> postPage = postService.findByAuthorPaged(actor, "title", "발야구", 1, 3);
    ...
    void t22() throws Exception {
        ...
        Page<Post> postPage = postService.findByAuthorPaged(actor, "content", "18명", 1, 3);
